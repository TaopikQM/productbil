...
const ProductList = ({ navigateToReviewPage}) => {
  ...
  useEffect(() => {
    const placesRef = ref(rtdb, 'product_B');
  ...
  const deletePlace = (id) => {
    const placeRef = ref(rtdb, `product_B/${id}`);
    remove(placeRef);
  };
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <div>
                      ...
                      <input type="text" id="rate" name="rate" value={newData.rate || ''} onChange={handleEditChange} placeholder="Ente rate" className="mb-2 border p-2 rounded w-full" />
